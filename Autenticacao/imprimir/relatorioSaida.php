...
function Header()
{
    ...
    $this->Cell(0,10,utf8_decode('Saída de Artigos do Stocks na Repográfia'),0,1,'C');
    $this->Cell(168,10,utf8_decode('Data Doc.'),0,0,'R');
    $this->SetFont('Arial','',10);
    $this->Cell(0,10,utf8_decode('29.12.12'),0,1,'C');
    ...
    WHERE estado_entrada < '$estadoDesactivo' and tipo_artigo = '$tipoArtigo' ORDER BY a.nome ";
