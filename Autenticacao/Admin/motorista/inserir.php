...
if (isset($_POST['add'])) {
  $Nome =  mysqli_escape_string($conexao,$_POST['motorSeguranca']);
  $CartaConducao =  mysqli_escape_string($conexao,$_POST['motorSeguranca']);
  $Telefone =  mysqli_escape_string($conexao,$_POST['motorSeguranca']);
  $Estadousuario =  mysqli_escape_string($conexao,$_POST['motorSeguranca']);
  $Endereco =  mysqli_escape_string($conexao,$_POST['motorSeguranca']);
